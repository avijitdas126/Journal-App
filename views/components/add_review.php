...
$id=$_GET['id'];
$sql="SELECT a.author_id,a.title,a.article_id,a.content_html,a.category, COALESCE(s.name, ad.name) AS author_name,
    a.author_type FROM `article` as a
    ...
    <div class="row py-2">
        <div class="col-12 d-flex" style="justify-content: space-between;align-items: center;">
            ...
            <div>
                ...
                <?php } ?>
                <span class="badge bg-secondary">Author: <?php echo htmlspecialchars($article['author_name']); ?></span>
            </div>
...
<div class="row py-2">
    <div class="col-12 mb-5">
        ...
        <h2>Add Review for This Article:</h2>
        <form action="<?php echo $base_url; ?>/views/components/api/submit_review.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="review-marks" name="marks" max=100 min=0 required>
            </div>
            <div class="mb-3">
