...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '' || $email === '' || $subject === '' || $message === '') {
        ...
        $body = "
            <h1>Contact Us – The Digital Scape</h1>
        ...
        $altbody = "
Contact Form – The Digital Scape
...
{$message}
        ...
        if ($sent) {
            $message_sent = true;
            header("Location: ".$base_url."/main.php?page=contact&status=success");
        } else {
    ...
    <head>
        ...
        <title>Contact Us - The Digital Scape</title>
        <style>
            body {
        ...
        <div class="contact-container">
            ...
            <div class="contact-content">
                ...
                <div class="contact-form">
                    ...
                    <form method="POST" action="<?php echo $base_url; ?>/views/components/contact.php">
