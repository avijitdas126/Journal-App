    ...
    <div class="row py-2">
        <div class="col-12 d-flex" style="justify-content: space-between;align-items: center;">
            <h1>
                ...
                <button type="button" class="btn btn-primary d-flex gap-1" style="align-items: center;" onclick="window.location.href='?page=add_article&id='+Date.now()"><svg
                ...
                <tbody>
                   <?php foreach($articles as $article){ ?>
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-primary" onclick="window.location.href='?page=edit_article&id=<?php echo $article['article_id'] ?>'">Edit</button>
                            <button class="btn btn-sm btn-danger" onclick="deleteArticle(<?php echo $article['article_id'] ?>)">Delete</button>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
